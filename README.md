...
私が本サービスを作ったきっかけは2点あります。それは、[**`①お金を介さない取引があっても良いとずっと考えていた`**,**`②アメリカでは直接会ってモノの受け渡しがされていることを発見した`**]の2点です。
...
**1:`DB設計で、ポリモーフィック関連にならないように設計したこと`, 2:`Userモデルでアイコンと背景画像のみdeleteリクエストを受け付けるようにしたこと`**
