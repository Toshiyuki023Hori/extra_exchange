# Generated by Django 3.1.1 on 2020-09-07 00:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='管理サイトへのアクセス権を持っているかどうか', verbose_name='staff status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='done_review', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'reviews',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choosingUser', models.ManyToManyField(related_name='pick_up', to=settings.AUTH_USER_MODEL)),
            ],
            options={
